...
DATASET_PATH = ROOT / "datasets/ml/walk_fullbody_quality_v1.jsonl"
MODEL_PATH = ROOT / "models/walk_fullbody_gru_v2_quality.pt"
SUMMARY_PATH = ROOT / "models/walk_fullbody_gru_v2_quality_summary.json"
    ...
    def __init__(self, path):
        ...
        with path.open("r", encoding="utf-8") as f:
            for line in f:
                ...
                self.items.append((states, action, ex.get("walk_quality_score", 1.0)))
