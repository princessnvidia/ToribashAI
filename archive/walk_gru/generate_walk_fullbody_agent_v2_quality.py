...
OUT_JSON = ROOT / "evolution" / "walk_fullbody_agent_v2_quality_current.json"

AGENT_NAME = "walk_fullbody_v2_quality"
...
def main():
    ...
    with torch.no_grad():
        for q, states, ex in examples:
            ...
            toribash_action = [full_action[j] for j in CONTROL_JOINTS]
