...
GENERATOR = SCRIPTS / "generate_sampled_walking_live_actions_v25.py"
PROJECT_LUA = SCRIPTS / "toribash_curated_walking_sampled_runner_v25.lua"
TORIBASH_LUA = TORIBASH_SCRIPT_DIR / "toribash_curated_walking_sampled_runner_v25.lua"

LUA_COMMAND = "/ls toribash_curated_walking_sampled_runner_v25.lua"
RESET_COMMAND = "/reset"
...
def main() -> None:
    ...
    print("Generating sampled walking actions V25...")
    ...
    print("Actions file:", TORIBASH_SCRIPT_DIR / "curated_walking_sampled_v25_live_actions_current.json")
    print()
