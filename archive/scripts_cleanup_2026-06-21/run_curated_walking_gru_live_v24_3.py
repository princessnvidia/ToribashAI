#!/usr/bin/env python3
"""
run_curated_walking_gru_live_v24_3.py

V24.3:
- génère les actions avec le générateur V24.1 compatible checkpoint
- copie le Lua V24.3 auto-run côté Steam
...
PROJECT_LUA = SCRIPTS / "toribash_curated_walking_gru_live_runner_v24_3.lua"
TORIBASH_LUA = TORIBASH_SCRIPT_DIR / "toribash_curated_walking_gru_live_runner_v24_3.lua"

LUA_COMMAND = "/ls toribash_curated_walking_gru_live_runner_v24_3.lua"
RESET_COMMAND = "/reset"
