#!/usr/bin/env python3
"""
run_curated_walking_gru_live_v24_1.py

Génère les actions V24.1 avec l'architecture correcte, copie le Lua V24 existant,
puis charge le runner dans Toribash.
"""
