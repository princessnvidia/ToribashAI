echo("################################################")
echo("[ToribashAI Balance V1] LUA LOADED")
echo("################################################")
...
if not ok then
    echo("[Balance V1] AGENT LOAD ERROR")
    echo(tostring(err))
    return false
    end

    echo("[Balance V1] agent = " .. tostring(TORIBASHAI_AGENT.name))
    return true
    end
                                                                    ...
                                                                    if finished then return end
                                                                        ...
                                                                        if not x then
                                                                            ...
                                                                            if fell then
                                                                                ...
                                                                                -- Très grosse pénalité si posture basse.
                                                                                if posture_z < 5.8 then
                                                                                    score = score - 300.0
                                                                                    end

                                                                                    echo("================================================")
                                                                                    echo("[Balance V1] SCORE = " .. tostring(score))
                                                                                    echo(string.format("[Balance V1] pos=%.2f %.2f %.2f posture=%.2f drift=%.2f", x, y, z, posture_z, drift))
                                                                                    echo("[Balance V1] fell=" .. tostring(fell) .. " reason=" .. tostring(reason))
                                                                                    echo("================================================")
                                                                                                                ...
                                                                                                                hold_all()
                                                                                                                    ...
                                                                                                                    if frame >= CONFIG.max_frames then
                                                                                                                        ...
                                                                                                                        if x and z < CONFIG.fall_z then
                                                                                                                            ...
                                                                                                                            add_hook("new_game", "toribashai_balance_runner_v1", on_new_game)
                                                                                                                            add_hook("draw2d", "toribashai_balance_runner_v1", on_draw2d)
                                                                                                                            add_hook("enter_frame", "toribashai_balance_runner_v1", on_enter_frame)
