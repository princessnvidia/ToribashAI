...
MODEL_PATH = BASE / "models" / "parkour_mlp_v1.pt"
OUT = BASE / "models" / "parkour_mlp_v1_eval.json"
...
def main():
    ...
    for joint_id in range(JOINTS):
        ...
        joint_confusions[str(joint_id)] = counter.most_common(20)
    ...
    summary = {
        ...
        "true_action_values": true_values.most_common(),
        "predicted_action_values": pred_values.most_common(),
