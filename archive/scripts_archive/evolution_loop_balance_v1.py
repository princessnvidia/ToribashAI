...
SEED_AGENT = ROOT / "evolution/balance_seed_v1.json"
CHAMPION_AGENT = ROOT / "evolution/balance_champion_v1.json"
...
POP_DIR = ROOT / "evolution/population_balance_v1"
BEST_DIR = ROOT / "evolution/best_balance_v1"
...
def export_lua(agent):
    lines = []
    lines.append("-- Auto-generated by evolution_loop_balance_v1.py")
...
def evaluate(agent, gen, idx):
    ...
    agent["name"] = f"balance_v1_gen_{gen:05d}_agent_{idx:03d}"
...
def main():
    ...
    print("/ls toribash_balance_runner_v3.lua")
    ...
    for gen in range(GENERATIONS):
        ...
        save_json(
            ROOT / "evolution/balance_v1_state.json",
            {
                "generation": gen,
