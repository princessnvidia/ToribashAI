...
DATASET = BASE / "datasets" / "ml" / "parkour_sequences_len8_val_by_replay.jsonl"
MODEL_PATH = BASE / "models" / "parkour_gru_v3_small_replay_split.pt"
OUT = BASE / "models" / "parkour_gru_v3_small_replay_split_val_eval.json"
