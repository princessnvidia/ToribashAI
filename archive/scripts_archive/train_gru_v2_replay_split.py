...
TRAIN_DATASET = BASE / "datasets" / "ml" / "parkour_sequences_len8_train_by_replay.jsonl"
VAL_DATASET = BASE / "datasets" / "ml" / "parkour_sequences_len8_val_by_replay.jsonl"

MODELS = BASE / "models"
MODEL_PATH = MODELS / "parkour_gru_v2_replay_split.pt"
SUMMARY_PATH = MODELS / "parkour_gru_v2_replay_split_summary.json"
...
class ParkourSequenceDataset(Dataset):
    def __init__(self, path, mean=None, std=None):
        ...
        self.states = (
            self.states - self.mean.view(1, 1, -1)
        ) / self.std.view(1, 1, -1)
