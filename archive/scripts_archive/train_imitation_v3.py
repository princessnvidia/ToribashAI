...
MODELS = BASE / "models"
MODEL_PATH = MODELS / "parkour_mlp_v3_sqrt_weighted.pt"
SUMMARY_PATH = MODELS / "parkour_mlp_v3_sqrt_weighted_summary.json"
...
def make_class_weights(class_counts, device):
    ...
    # V3 : pondération adoucie.
    # Au lieu d'utiliser inverse_frequency brutalement, on prend sa racine carrée.
