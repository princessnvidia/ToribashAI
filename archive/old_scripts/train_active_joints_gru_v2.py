...
MODEL_PATH = PROJECT_DIR / "models" / "parkour_active_joints_gru_v2_soft_weighted.pt"
SUMMARY_PATH = PROJECT_DIR / "models" / "parkour_active_joints_gru_v2_soft_weighted_summary.json"
