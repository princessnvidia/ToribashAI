...
MODEL_PATH = PROJECT_DIR / "models" / "parkour_active_joints_gru_v3_mid_weighted.pt"
SUMMARY_PATH = PROJECT_DIR / "models" / "parkour_active_joints_gru_v3_mid_weighted_summary.json"
