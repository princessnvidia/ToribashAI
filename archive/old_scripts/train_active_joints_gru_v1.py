...
MODEL_PATH = PROJECT_DIR / "models" / "parkour_active_joints_gru_v1.pt"
SUMMARY_PATH = PROJECT_DIR / "models" / "parkour_active_joints_gru_v1_summary.json"
...
def compute_pos_weight(dataset: Dataset):
    ...
    pos_weight = negative / positive.clamp(min=1.0)
