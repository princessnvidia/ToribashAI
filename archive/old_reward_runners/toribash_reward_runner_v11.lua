echo("################################################")
echo("[ToribashAI V11] LUA LOADED - FULL ARMS + RESULT FILE")
echo("################################################")
                                                                    ...
                                                                    if not x then
                                                                        ...
                                                                        if start_y then progress_y = start_y - y end
                                                                            ...
                                                                            if fell then score = score - 150.0 end
                                                                                ...
                                                                                echo("[ToribashAI V11] NEW GAME")
                                                                                echo("[ToribashAI V11] loaded agent = " .. tostring(TORIBASHAI_AGENT.name))
                                                                                                        ...
                                                                                                        if frame >= CONFIG.warmup_frames then
                                                                                                            ...
                                                                                                            if frame % 60 == 0 and x then
                                                                                                                ...
                                                                                                                if frame >= CONFIG.max_frames then
                                                                                                                    ...
                                                                                                                    add_hook("new_game", "toribashai_reward_runner_v11", on_new_game)
                                                                                                                    add_hook("draw2d", "toribashai_reward_runner_v11", on_draw2d)
                                                                                                                    add_hook("enter_frame", "toribashai_reward_runner_v11", on_enter_frame)
