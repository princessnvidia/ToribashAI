echo("################################################")
echo("[ToribashAI V16] LUA LOADED - CONTROL FILE RESET TEST")
echo("################################################")
...
local CONFIG = {
    ...
    control_path = "toribashai_control_v16.txt"
}
...
if not ok then
    echo("[ToribashAI V16] AGENT LOAD ERROR")
    echo(tostring(err))
    return false
    end

    echo("################################################")
    echo("[ToribashAI V16] AGENT RELOADED")
    echo("[ToribashAI V16] loaded agent = " .. tostring(TORIBASHAI_AGENT.name))
    echo("################################################")
                        ...
                        for _, id in ipairs(ids) do
                            ...
                            if ok and x and y and z then
                                ...
                                if c == 0 then return nil end
                                    ...
                                    if not f then
                                        echo("[ToribashAI V16] ERROR: cannot write result file")
                                        echo("[ToribashAI V16] path = " .. CONFIG.result_path)
                                        return
                                        end
                                        ...
                                        f:close()
                                        echo("[ToribashAI V16] Result written: " .. CONFIG.result_path)
                                        end
                                        ...
                                        if frame % 80 < 40 then
                                            ...
                                            set_joint_state(0, 9, 4, true)
                                                ...
                                                if not TORIBASHAI_AGENT or not TORIBASHAI_AGENT.actions then
                                                    echo("[ToribashAI V16] ERROR agent/actions nil")
                                                    hold_all()
                                                    return
                                                    end
                                                        ...
                                                        if not action then
                                                            ...
                                                            for i, joint_id in ipairs(AGENT_JOINTS) do
                                                                ...
                                                                if started_physics then return end
                                                                    ...
                                                                    echo("[ToribashAI V16] STARTING PHYSICS")
                                                                    ...
                                                                    if finished then return end
                                                                        ...
                                                                        if not x then
                                                                            echo("[ToribashAI V16] NIL POSITION ERROR")
                                                                            freeze_game()
                                                                            return
                                                                            end
                                                                            ...
                                                                            if start_y then progress_y = start_y - y end
                                                                                ...
                                                                                if fell then score = score - 150.0 end
                                                                                    if reason == "bad_progress" then score = score - 25.0 end
                                                                                        ...
                                                                                        echo("================================================")
                                                                                        echo("[ToribashAI V16] AGENT = " .. tostring(TORIBASHAI_AGENT.name))
                                                                                        echo(string.format("[ToribashAI V16] FINAL SCORE = %.2f", score))
                                                                                        echo(string.format("[ToribashAI V16] FINAL POS = %.2f %.2f %.2f", x, y, z))
                                                                                        echo(string.format("[ToribashAI V16] FINAL DIST = %.2f", final_dist))
                                                                                        echo(string.format("[ToribashAI V16] PROGRESS_Y = %.2f", progress_y))
                                                                                        echo("[ToribashAI V16] FELL = " .. tostring(fell))
                                                                                        echo("[ToribashAI V16] REASON = " .. tostring(reason))
                                                                                        echo("================================================")
                                                                                        ...
                                                                                        local function do_reset_attempt()
                                                                                        echo("[ToribashAI V16] RESET ATTEMPT")

                                                                                        local ok1, err1 = pcall(function()
                                                                                        runCmd("reset")
                                                                                        end)

                                                                                        echo("[ToribashAI V16] runCmd reset ok = " .. tostring(ok1))
                                                                                        if not ok1 then echo("[ToribashAI V16] runCmd err = " .. tostring(err1)) end

                                                                                            local ok2, err2 = pcall(function()
                                                                                            start_new_game(true)
                                                                                            end)

                                                                                            echo("[ToribashAI V16] start_new_game(true) ok = " .. tostring(ok2))
                                                                                            if not ok2 then echo("[ToribashAI V16] start_new_game(true) err = " .. tostring(err2)) end

                                                                                                local ok3, err3 = pcall(function()
                                                                                                start_new_game()
                                                                                                end)

                                                                                                echo("[ToribashAI V16] start_new_game() ok = " .. tostring(ok3))
                                                                                                if not ok3 then echo("[ToribashAI V16] start_new_game() err = " .. tostring(err3)) end
                                                                                                    end
                                                                                                    ...
                                                                                                    if running then return end
                                                                                                        ...
                                                                                                        if not f then return end
                                                                                                            ...
                                                                                                            echo("[ToribashAI V16] CONTROL FILE DETECTED: " .. tostring(cmd))

                                                                                                            pending_reset_ticks = 10
                                                                                                            end
                                                                                                            ...
                                                                                                            if not ok then
                                                                                                                ...
                                                                                                                if pending_reset_ticks > 0 then
                                                                                                                    pending_reset_ticks = pending_reset_ticks - 1
                                                                                                                                            ...
                                                                                                                                            hold_all()
                                                                                                                                                ...
                                                                                                                                                if frame >= CONFIG.warmup_frames then
                                                                                                                                                    ...
                                                                                                                                                    if frame % 60 == 0 and x then
                                                                                                                                                        echo(string.format(
                                                                                                                                                            "[ToribashAI V16] frame=%d pos=%.2f %.2f %.2f dist=%.2f",
                                                                                                                                                        ...
                                                                                                                                                        if frame >= CONFIG.early_stop_frames and x and start_y then
                                                                                                                                                            ...
                                                                                                                                                            if z < CONFIG.fall_z then
                                                                                                                                                                echo("[ToribashAI V16] EARLY STOP: fell")
                                                                                                                                                                finish_run("fell")
                                                                                                                                                                return
                                                                                                                                                                end

                                                                                                                                                                if progress_y < CONFIG.min_progress_y then
                                                                                                                                                                    echo("[ToribashAI V16] EARLY STOP: bad_progress")
                                                                                                                                                                    ...
                                                                                                                                                                    if frame >= CONFIG.max_frames then
                                                                                                                                                                        ...
                                                                                                                                                                        add_hook("new_game", "toribashai_reward_runner_v16", on_new_game)
                                                                                                                                                                        add_hook("draw2d", "toribashai_reward_runner_v16", on_draw2d)
                                                                                                                                                                        add_hook("enter_frame", "toribashai_reward_runner_v16", on_enter_frame)
