echo("################################################")
echo("[ToribashAI V13.2] LUA LOADED - FAST EVOLUTION")
echo("################################################")
...
if not ok then
    echo("[ToribashAI V13.2] AGENT LOAD ERROR")
    echo(tostring(err))
    return false
    end

    echo("################################################")
    echo("[ToribashAI V13.2] AGENT RELOADED")
    echo("[ToribashAI V13.2] loaded agent = " .. tostring(TORIBASHAI_AGENT.name))
    echo("################################################")
                        ...
                        for _, id in ipairs(ids) do
                            ...
                            if ok and x and y and z then
                                ...
                                if c == 0 then return nil end
                                    ...
                                    if not f then
                                        echo("[ToribashAI V13.2] ERROR: cannot write result file")
                                        echo("[ToribashAI V13.2] path = " .. CONFIG.result_path)
                                        return
                                        end
                                        ...
                                        f:close()
                                        echo("[ToribashAI V13.2] Result written: " .. CONFIG.result_path)
                                        end
                                        ...
                                        if frame % 80 < 40 then
                                            ...
                                            set_joint_state(0, 9, 4, true)
                                                ...
                                                if not TORIBASHAI_AGENT or not TORIBASHAI_AGENT.actions then
                                                    echo("[ToribashAI V13.2] ERROR agent/actions nil")
                                                    hold_all()
                                                    return
                                                    end
                                                        ...
                                                        if not action then
                                                            ...
                                                            for i, joint_id in ipairs(AGENT_JOINTS) do
                                                                ...
                                                                if started_physics then return end
                                                                    ...
                                                                    echo("[ToribashAI V13.2] STARTING PHYSICS")
                                                                    ...
                                                                    if finished then return end
                                                                        ...
                                                                        if not x then
                                                                            echo("[ToribashAI V13.2] NIL POSITION ERROR")
                                                                            freeze_game()
                                                                            return
                                                                            end
                                                                            ...
                                                                            if start_y then progress_y = start_y - y end
                                                                                ...
                                                                                if fell then score = score - 150.0 end
                                                                                    if reason == "bad_progress" then score = score - 25.0 end
                                                                                        ...
                                                                                        echo("================================================")
                                                                                        echo("[ToribashAI V13.2] AGENT = " .. tostring(TORIBASHAI_AGENT.name))
                                                                                        echo(string.format("[ToribashAI V13.2] FINAL SCORE = %.2f", score))
                                                                                        echo(string.format("[ToribashAI V13.2] FINAL POS = %.2f %.2f %.2f", x, y, z))
                                                                                        echo(string.format("[ToribashAI V13.2] FINAL DIST = %.2f", final_dist))
                                                                                        echo(string.format("[ToribashAI V13.2] PROGRESS_Y = %.2f", progress_y))
                                                                                        echo("[ToribashAI V13.2] FELL = " .. tostring(fell))
                                                                                        echo("[ToribashAI V13.2] REASON = " .. tostring(reason))
                                                                                        echo("================================================")
                                                                                        ...
                                                                                        if not ok then
                                                                                            ...
                                                                                            echo("[ToribashAI V13.2] NEW GAME")
                                                                                                                ...
                                                                                                                hold_all()
                                                                                                                    ...
                                                                                                                    if frame >= CONFIG.warmup_frames then
                                                                                                                        ...
                                                                                                                        if frame % 60 == 0 and x then
                                                                                                                            echo(string.format(
                                                                                                                                "[ToribashAI V13.2] frame=%d pos=%.2f %.2f %.2f dist=%.2f",
                                                                                                                                frame,
                                                                                                                                x,
                                                                                                                                y,
                                                                                                                                z,
                                                                                                                            ...
                                                                                                                            if frame >= CONFIG.early_stop_frames and x and start_y then
                                                                                                                                ...
                                                                                                                                if z < CONFIG.fall_z then
                                                                                                                                    echo("[ToribashAI V13.2] EARLY STOP: fell")
                                                                                                                                    finish_run("fell")
                                                                                                                                    return
                                                                                                                                    end

                                                                                                                                    if progress_y < CONFIG.min_progress_y then
                                                                                                                                        echo("[ToribashAI V13.2] EARLY STOP: bad_progress")
                                                                                                                                        ...
                                                                                                                                        if frame >= CONFIG.max_frames then
                                                                                                                                            ...
                                                                                                                                            add_hook("new_game", "toribashai_reward_runner_v13_2", on_new_game)
                                                                                                                                            add_hook("draw2d", "toribashai_reward_runner_v13_2", on_draw2d)
                                                                                                                                            add_hook("enter_frame", "toribashai_reward_runner_v13_2", on_enter_frame)
