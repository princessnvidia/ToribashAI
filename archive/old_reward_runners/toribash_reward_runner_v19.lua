echo("################################################")
echo("[ToribashAI V19] LUA LOADED - CLEAN CONTROL RESET")
echo("################################################")
...
local CONFIG = {
    ...
    control_path = "toribashai_control_v19.txt"
}
...
if not ok then
    echo("[ToribashAI V19] AGENT LOAD ERROR")
    echo(tostring(err))
    return false
    end

    echo("################################################")
    echo("[ToribashAI V19] AGENT RELOADED")
    echo("[ToribashAI V19] loaded agent = " .. tostring(TORIBASHAI_AGENT.name))
    echo("################################################")
                        ...
                        for _, id in ipairs(ids) do
                            ...
                            if ok and x and y and z then
                                ...
                                if c == 0 then return nil end
                                    ...
                                    if not f then
                                        echo("[ToribashAI V19] ERROR: cannot write result file")
                                        echo("[ToribashAI V19] path = " .. CONFIG.result_path)
                                        return
                                        end
                                        ...
                                        f:close()
                                        echo("[ToribashAI V19] Result written: " .. CONFIG.result_path)
                                        end
                                        ...
                                        if frame % 80 < 40 then
                                            ...
                                            set_joint_state(0, 9, 4, true)
                                                ...
                                                if not TORIBASHAI_AGENT or not TORIBASHAI_AGENT.actions then
                                                    echo("[ToribashAI V19] ERROR agent/actions nil")
                                                    hold_all()
                                                    return
                                                    end
                                                        ...
                                                        if not action then
                                                            ...
                                                            for i, joint_id in ipairs(AGENT_JOINTS) do
                                                                ...
                                                                if started_physics then return end
                                                                    ...
                                                                    echo("[ToribashAI V19] STARTING PHYSICS")
                                                                    ...
                                                                    if finished then return end
                                                                        ...
                                                                        if not x then
                                                                            echo("[ToribashAI V19] NIL POSITION ERROR")
                                                                            freeze_game()
                                                                            return
                                                                            end
                                                                            ...
                                                                            if start_y then progress_y = start_y - y end
                                                                                ...
                                                                                if fell then score = score - 150.0 end
                                                                                    if reason == "bad_progress" then score = score - 25.0 end
                                                                                        ...
                                                                                        echo("================================================")
                                                                                        echo("[ToribashAI V19] AGENT = " .. tostring(TORIBASHAI_AGENT.name))
                                                                                        echo(string.format("[ToribashAI V19] FINAL SCORE = %.2f", score))
                                                                                        echo(string.format("[ToribashAI V19] FINAL POS = %.2f %.2f %.2f", x, y, z))
                                                                                        echo(string.format("[ToribashAI V19] FINAL DIST = %.2f", final_dist))
                                                                                        echo(string.format("[ToribashAI V19] PROGRESS_Y = %.2f", progress_y))
                                                                                        echo("[ToribashAI V19] FELL = " .. tostring(fell))
                                                                                        echo("[ToribashAI V19] REASON = " .. tostring(reason))
                                                                                        echo("================================================")
                                                                                        ...
                                                                                        if not f then return end
                                                                                            ...
                                                                                            echo("[ToribashAI V19] CONTROL FILE DETECTED: " .. tostring(cmd))
                                                                                            echo("[ToribashAI V19] RESET TRUE NOW")

                                                                                            local ok, err = pcall(function()
                                                                                            runCmd("reset", true)
                                                                                            end)

                                                                                            echo("[ToribashAI V19] reset ok = " .. tostring(ok))
                                                                                            if not ok then
                                                                                                echo("[ToribashAI V19] reset error = " .. tostring(err))
                                                                                                end
                                                                                                end
                                                                                                                        ...
                                                                                                                        hold_all()
                                                                                                                            ...
                                                                                                                            if frame >= CONFIG.warmup_frames then
                                                                                                                                ...
                                                                                                                                if frame % 60 == 0 and x then
                                                                                                                                    echo(string.format(
                                                                                                                                        "[ToribashAI V19] frame=%d pos=%.2f %.2f %.2f dist=%.2f",
                                                                                                                                    ...
                                                                                                                                    if frame >= CONFIG.early_stop_frames and x and start_y then
                                                                                                                                        ...
                                                                                                                                        if z < CONFIG.fall_z then
                                                                                                                                            echo("[ToribashAI V19] EARLY STOP: fell")
                                                                                                                                            finish_run("fell")
                                                                                                                                            return
                                                                                                                                            end

                                                                                                                                            if progress_y < CONFIG.min_progress_y then
                                                                                                                                                echo("[ToribashAI V19] EARLY STOP: bad_progress")
                                                                                                                                                ...
                                                                                                                                                if frame >= CONFIG.max_frames then
                                                                                                                                                    ...
                                                                                                                                                    add_hook("new_game", "toribashai_reward_runner_v19", on_new_game)
                                                                                                                                                    add_hook("draw2d", "toribashai_reward_runner_v19", on_draw2d)
                                                                                                                                                    add_hook("enter_frame", "toribashai_reward_runner_v19", on_enter_frame)
