echo("################################################")
echo("[ToribashAI V4] LUA LOADED - PAUSE/FREEZE DEBUG")
echo("################################################")
...
if is_game_paused then
    ...
    if is_game_frozen then
        ...
        echo("[ToribashAI V4] " .. label .. " paused=" .. paused .. " frozen=" .. frozen)
        end
                                    ...
                                    for j = 0, 19 do
                                        ...
                                        if frame % 80 < 40 then
                                            ...
                                            set_joint_state(0, 19, 2, true)
                                                ...
                                                local function force_start_physics(source)
                                                if started_physics then
                                                    ...
                                                    echo("[ToribashAI V4] FORCE START from " .. source)
                                                    log_state("before force start")

                                                    hold_all()

                                                    unfreeze_game()
                                                    log_state("after unfreeze_game")

                                                    -- Plusieurs tentatives : pause hotkey + step + run.
                                                    toggle_game_pause(false)
                                                    log_state("after toggle_game_pause false")

                                                    step_game(false, false)
                                                    log_state("after step_game false false")

                                                    run_frames(1)
                                                    log_state("after run_frames 1")

                                                    run_frames(10)
                                                    log_state("after run_frames 10")
                                                    end
                                                    ...
                                                    if not x then
                                                        echo("================================================")
                                                        echo("[ToribashAI V4] NIL POSITION ERROR")
                                                        echo("[ToribashAI V4] THIS IS V4")
                                                        echo("[ToribashAI V4] EVALUATION COMPLETE")
                                                        echo("================================================")
                                                        freeze_game()
                                                        return
                                                        end
                                                                    ...
                                                                    if final_dist < 3.0 then
                                                                        ...
                                                                        elseif final_dist < 6.0 then
                                                                            ...
                                                                            elseif final_dist < 10.0 then
                                                                                ...
                                                                                echo("================================================")
                                                                                echo(string.format("[ToribashAI V4] FINAL SCORE = %.2f", score))
                                                                                echo(string.format("[ToribashAI V4] FINAL POS = %.2f %.2f %.2f", x, y, z))
                                                                                echo(string.format("[ToribashAI V4] FINAL DIST = %.2f", final_dist))
                                                                                echo(string.format("[ToribashAI V4] PROGRESS_Y = %.2f", progress_y))
                                                                                echo("[ToribashAI V4] FELL = " .. tostring(fell))
                                                                                echo("[ToribashAI V4] THIS IS V4")
                                                                                echo("[ToribashAI V4] EVALUATION COMPLETE")
                                                                                echo("================================================")
                                                                                ...
                                                                                if not running or started_physics then
                                                                                    ...
                                                                                    if boot_ticks == 10 then
                                                                                        ...
                                                                                        if boot_ticks == 30 then
                                                                                            force_start_physics("draw2d tick 30")
                                                                                                end
                                                                                                end
                                                                                                        ...
                                                                                                        if frame < 20 then
                                                                                                            hold_all()
                                                                                                                ...
                                                                                                                if frame % 30 == 0 and x then
                                                                                                                    ...
                                                                                                                    echo(string.format("[ToribashAI V4] frame=%d pos=%.2f %.2f %.2f dist=%.2f", frame, x, y, z, dist))
                                                                                                                    ...
                                                                                                                    if frame >= CONFIG.max_frames then
                                                                                                                        ...
                                                                                                                        add_hook("new_game", "toribashai_reward_runner_v4", on_new_game)
                                                                                                                        add_hook("draw2d", "toribashai_reward_runner_v4", on_draw2d)
                                                                                                                        add_hook("enter_frame", "toribashai_reward_runner_v4", on_enter_frame)
