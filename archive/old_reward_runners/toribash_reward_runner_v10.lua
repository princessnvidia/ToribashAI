echo("################################################")
echo("[ToribashAI V10] LUA LOADED - FULL ARMS + RESULT FILE")
echo("################################################")
...
local CONFIG = {
    ...
    warmup_frames = 20,
    result_path = "/home/vio/Documents/ToribashAI/lua_runtime/episode_result.json"
}
                    ...
                    for _, id in ipairs(ids) do
                        ...
                        if ok and x and y and z then
                            ...
                            if c == 0 then return nil end
                                ...
                                local function write_result(score, x, y, z, final_dist, progress_y, fell)
                                local f = io.open(CONFIG.result_path, "w")

                                if not f then
                                    echo("[ToribashAI V10] ERROR: cannot write result file")
                                    echo("[ToribashAI V10] path = " .. CONFIG.result_path)
                                    return
                                    end

                                    f:write(string.format(
                                        '{"score": %.4f, "x": %.4f, "y": %.4f, "z": %.4f, "final_dist": %.4f, "progress_y": %.4f, "fell": %s, "frames": %d, "agent": "%s"}\n',
                                        score,
                                        x,
                                        y,
                                        z,
                                    ...
                                    f:close()
                                    echo("[ToribashAI V10] Result written: " .. CONFIG.result_path)
                                    end
                                    ...
                                    if frame % 80 < 40 then
                                        ...
                                        set_joint_state(0, 9, 4, true)
                                            ...
                                            if not TORIBASHAI_AGENT or not TORIBASHAI_AGENT.actions then
                                                echo("[ToribashAI V10] ERROR agent/actions nil")
                                                hold_all()
                                                return
                                                end
                                                    ...
                                                    if not action then
                                                        ...
                                                        for i, joint_id in ipairs(AGENT_JOINTS) do
                                                            ...
                                                            if frame == 20 or frame == 40 or frame == 60 then
                                                                echo("[ToribashAI V10] action_index=" .. tostring(action_index))
                                                                echo("[ToribashAI V10] action_len=" .. tostring(#action))
                                                                echo("[ToribashAI V10] extra arms 8/9 active")
                                                                end
                                                                end
                                                                ...
                                                                if started_physics then return end
                                                                    ...
                                                                    echo("[ToribashAI V10] STARTING PHYSICS")
                                                                    ...
                                                                    if not x then
                                                                        echo("[ToribashAI V10] NIL POSITION ERROR")
                                                                        freeze_game()
                                                                        return
                                                                        end
                                                                        ...
                                                                        if start_y then progress_y = start_y - y end
                                                                            ...
                                                                            if fell then score = score - 150.0 end
                                                                                ...
                                                                                echo("================================================")
                                                                                echo("[ToribashAI V10] AGENT = " .. tostring(TORIBASHAI_AGENT.name))
                                                                                echo(string.format("[ToribashAI V10] FINAL SCORE = %.2f", score))
                                                                                echo(string.format("[ToribashAI V10] FINAL POS = %.2f %.2f %.2f", x, y, z))
                                                                                echo(string.format("[ToribashAI V10] FINAL DIST = %.2f", final_dist))
                                                                                echo(string.format("[ToribashAI V10] PROGRESS_Y = %.2f", progress_y))
                                                                                echo("[ToribashAI V10] FELL = " .. tostring(fell))
                                                                                echo("================================================")

                                                                                write_result(score, x, y, z, final_dist, progress_y, fell)
                                                                                freeze_game()
                                                                                end

                                                                                local function on_new_game()
                                                                                echo("[ToribashAI V10] NEW GAME")
                                                                                echo("[ToribashAI V10] loaded agent = " .. tostring(TORIBASHAI_AGENT.name))
                                                                                                    ...
                                                                                                    hold_all()
                                                                                                        ...
                                                                                                        if frame >= CONFIG.warmup_frames then
                                                                                                            ...
                                                                                                            if frame % 60 == 0 and x then
                                                                                                                echo(string.format(
                                                                                                                    "[ToribashAI V10] frame=%d pos=%.2f %.2f %.2f dist=%.2f",
                                                                                                                ...
                                                                                                                if frame >= CONFIG.max_frames then
                                                                                                                    ...
                                                                                                                    add_hook("new_game", "toribashai_reward_runner_v10", on_new_game)
                                                                                                                    add_hook("draw2d", "toribashai_reward_runner_v10", on_draw2d)
                                                                                                                    add_hook("enter_frame", "toribashai_reward_runner_v10", on_enter_frame)
