echo("################################################")
echo("[ToribashAI V12] LUA LOADED - HOT RELOAD AGENTS")
echo("################################################")
...
echo("################################################")
echo("[ToribashAI V12] AGENT RELOADED")
echo("[ToribashAI V12] loaded agent = " .. tostring(TORIBASHAI_AGENT.name))
echo("################################################")
end
                    ...
                    for _, id in ipairs(ids) do
                        ...
                        if ok and x and y and z then
                            ...
                            if c == 0 then return nil end
                                ...
                                if not f then
                                    echo("[ToribashAI V11] ERROR: cannot write result file")
                                    echo("[ToribashAI V11] path = " .. CONFIG.result_path)
                                    return
                                    end
                                    ...
                                    f:close()
                                    echo("[ToribashAI V11] Result written: " .. CONFIG.result_path)
                                    end
                                    ...
                                    if frame % 80 < 40 then
                                        ...
                                        set_joint_state(0, 9, 4, true)
                                            ...
                                            if not TORIBASHAI_AGENT or not TORIBASHAI_AGENT.actions then
                                                echo("[ToribashAI V11] ERROR agent/actions nil")
                                                hold_all()
                                                return
                                                end
                                                    ...
                                                    if not action then
                                                        ...
                                                        for i, joint_id in ipairs(AGENT_JOINTS) do
                                                            ...
                                                            if frame == 20 or frame == 40 or frame == 60 then
                                                                echo("[ToribashAI V11] action_index=" .. tostring(action_index))
                                                                echo("[ToribashAI V11] action_len=" .. tostring(#action))
                                                                echo("[ToribashAI V11] extra arms 8/9 active")
                                                                end
                                                                end
                                                                ...
                                                                if started_physics then return end
                                                                    ...
                                                                    echo("[ToribashAI V11] STARTING PHYSICS")
                                                                    ...
                                                                    if not x then
                                                                        echo("[ToribashAI V11] NIL POSITION ERROR")
                                                                        freeze_game()
                                                                        return
                                                                        end
                                                                        ...
                                                                        if start_y then progress_y = start_y - y end
                                                                            ...
                                                                            if fell then score = score - 150.0 end
                                                                                ...
                                                                                echo("================================================")
                                                                                echo("[ToribashAI V11] AGENT = " .. tostring(TORIBASHAI_AGENT.name))
                                                                                echo(string.format("[ToribashAI V11] FINAL SCORE = %.2f", score))
                                                                                echo(string.format("[ToribashAI V11] FINAL POS = %.2f %.2f %.2f", x, y, z))
                                                                                echo(string.format("[ToribashAI V11] FINAL DIST = %.2f", final_dist))
                                                                                echo(string.format("[ToribashAI V11] PROGRESS_Y = %.2f", progress_y))
                                                                                echo("[ToribashAI V11] FELL = " .. tostring(fell))
                                                                                echo("================================================")
                                                                                                    ...
                                                                                                    hold_all()
                                                                                                        ...
                                                                                                        if frame >= CONFIG.warmup_frames then
                                                                                                            ...
                                                                                                            if frame % 60 == 0 and x then
                                                                                                                echo(string.format(
                                                                                                                    "[ToribashAI V11] frame=%d pos=%.2f %.2f %.2f dist=%.2f",
                                                                                                                ...
                                                                                                                if frame >= CONFIG.max_frames then
                                                                                                                    ...
                                                                                                                    add_hook("new_game", "toribashai_reward_runner_v12", on_new_game)
                                                                                                                    add_hook("draw2d", "toribashai_reward_runner_v12", on_draw2d)
                                                                                                                    add_hook("enter_frame", "toribashai_reward_runner_v12", on_enter_frame)
