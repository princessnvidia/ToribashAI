echo("################################################")
echo("[ToribashAI V8] LUA LOADED - FULLBODY CLEAN")
echo("################################################")
                        ...
                        if ok and x and y and z then
                            ...
                            if c == 0 then return nil end
                                ...
                                if not TORIBASHAI_AGENT then
                                    echo("[ToribashAI V8] ERROR agent nil")
                                    hold_all()
                                    return
                                    end

                                    if not TORIBASHAI_AGENT.actions then
                                        echo("[ToribashAI V8] ERROR actions nil")
                                        hold_all()
                                        return
                                        end
                                        ...
                                        if action_index < 1 then action_index = 1 end
                                            ...
                                            if not action then
                                                ...
                                                for i, joint_id in ipairs(CONTROL_JOINTS) do
                                                    set_joint_state(0, joint_id, action[i] or 3, true)
                                                    end
                                                    ...
                                                    if frame == 20 or frame == 40 or frame == 60 then
                                                        echo("[ToribashAI V8] action_index=" .. tostring(action_index))
                                                        echo("[ToribashAI V8] action_len=" .. tostring(#action))
                                                        echo(string.format(
                                                            "[ToribashAI V8] action=%s,%s,%s,%s,%s,%s,%s,%s,%s,%s",
                                                            tostring(action[1]), tostring(action[2]), tostring(action[3]), tostring(action[4]), tostring(action[5]),
                                                                           tostring(action[6]), tostring(action[7]), tostring(action[8]), tostring(action[9]), tostring(action[10])
                                                        ))
                                                        end
                                                        end
                                                        ...
                                                        if started_physics then return end
                                                            ...
                                                            echo("[ToribashAI V8] STARTING PHYSICS")
                                                            ...
                                                            if not x then
                                                                echo("[ToribashAI V8] NIL POSITION ERROR")
                                                                freeze_game()
                                                                return
                                                                end
                                                                ...
                                                                if start_y then
                                                                    ...
                                                                    if fell then score = score - 150.0 end
                                                                        ...
                                                                        echo("================================================")
                                                                        echo("[ToribashAI V8] AGENT = " .. tostring(TORIBASHAI_AGENT.name))
                                                                        echo(string.format("[ToribashAI V8] FINAL SCORE = %.2f", score))
                                                                        echo(string.format("[ToribashAI V8] FINAL POS = %.2f %.2f %.2f", x, y, z))
                                                                        echo(string.format("[ToribashAI V8] FINAL DIST = %.2f", final_dist))
                                                                        echo(string.format("[ToribashAI V8] PROGRESS_Y = %.2f", progress_y))
                                                                        echo("[ToribashAI V8] FELL = " .. tostring(fell))
                                                                        echo("[ToribashAI V8] THIS IS V8 FULLBODY")
                                                                        echo("================================================")
                                                                        ...
                                                                        echo("[ToribashAI V8] NEW GAME")
                                                                        echo("[ToribashAI V8] loaded agent = " .. tostring(TORIBASHAI_AGENT.name))

                                                                        if TORIBASHAI_AGENT.actions then
                                                                            echo("[ToribashAI V8] actions count = " .. tostring(#TORIBASHAI_AGENT.actions))
                                                                            end
                                                                                                ...
                                                                                                hold_all()
                                                                                                    ...
                                                                                                    if frame >= CONFIG.warmup_frames then
                                                                                                        ...
                                                                                                        if frame % 60 == 0 and x then
                                                                                                            echo(string.format(
                                                                                                                "[ToribashAI V8] frame=%d pos=%.2f %.2f %.2f dist=%.2f",
                                                                                                            ...
                                                                                                            if frame >= CONFIG.max_frames then
                                                                                                                ...
                                                                                                                add_hook("new_game", "toribashai_reward_runner_v8", on_new_game)
                                                                                                                add_hook("draw2d", "toribashai_reward_runner_v8", on_draw2d)
                                                                                                                add_hook("enter_frame", "toribashai_reward_runner_v8", on_enter_frame)
