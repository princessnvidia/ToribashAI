...
POP_DIR = ROOT / "evolution" / "population_fullbody_v8_v25_control"
BEST_DIR = ROOT / "evolution" / "best_fullbody_v8_v25_control"
...
CONTROL_FILE = TORIBASH_SCRIPT_DIR / "toribashai_control_v22.txt"
...
def evaluate(agent_path, gen, i):
    ...
    print("Reset demandé via :", CONTROL_FILE)
    print("=================================================")
...
def main():
    ...
    print("/ls toribash_reward_runner_v25.lua")
    print()
    input("Quand V25 est chargé, appuie Entrée ici... ")
    ...
    for gen in range(GENERATIONS):
        ...
        for i in range(POP_SIZE):
            ...
            candidate["runner"] = "toribash_reward_runner_v25.lua"
        ...
        summary = {
            ...
            "population": POP_SIZE,
            "runner": "toribash_reward_runner_v25.lua",
        }

        save_json(
            ROOT / "evolution" / "fullbody_v8_v25_control_last_summary.json",
            summary,
        )
