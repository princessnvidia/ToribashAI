...
PROJECT_LUA = ROOT / "scripts/toribash_walk_xioi_imitation_runner_v3.lua"
TORIBASH_LUA = TORIBASH_SCRIPT_DIR / "toribash_walk_xioi_imitation_runner_v3.lua"
...
POP_DIR = ROOT / "evolution/population_walk_xioi_imitation_v3"
BEST_DIR = ROOT / "evolution/best_walk_xioi_imitation_v3"
STATE_PATH = ROOT / "evolution/walk_xioi_imitation_v3_state.json"
...
def mutate(agent):
    ...
    child["mutation_strategy"] = "walk_xioi_imitation_v3_reference_trajectory_soft_mutation"
...
def reload_lua():
    send_chat_command("/ls toribash_walk_xioi_imitation_runner_v3.lua")
    time.sleep(0.5)
...
def evaluate(agent, gen, idx):
    agent = normalize_agent(agent)
    agent["name"] = f"walk_xioi_imitation_v3_gen_{gen:05d}_agent_{idx:03d}"
    ...
    for gen in range(GENERATIONS):
        ...
        save_json(
            STATE_PATH,
            {
                ...
                "mutation_strategy": "walk_xioi_imitation_v3_reference_trajectory_soft_mutation",
