...
PROJECT_LUA = ROOT / "scripts/toribash_walk_xioi_imitation_runner_v1.lua"
TORIBASH_LUA = TORIBASH_SCRIPT_DIR / "toribash_walk_xioi_imitation_runner_v1.lua"
...
POP_DIR = ROOT / "evolution/population_walk_xioi_imitation_v1"
BEST_DIR = ROOT / "evolution/best_walk_xioi_imitation_v1"
STATE_PATH = ROOT / "evolution/walk_xioi_imitation_v1_state.json"
...
def mutate(agent):
    ...
    child["mutation_strategy"] = "walk_xioi_imitation_v1_soft_mutation"
...
def reload_lua():
    send_chat_command("/ls toribash_walk_xioi_imitation_runner_v1.lua")
    time.sleep(0.5)
...
def evaluate(agent, gen, idx):
    agent = normalize_agent(agent)
    agent["name"] = f"walk_xioi_imitation_v1_gen_{gen:05d}_agent_{idx:03d}"
    ...
    for gen in range(GENERATIONS):
        ...
        save_json(
            STATE_PATH,
            {
                ...
                "mutation_strategy": "walk_xioi_imitation_v1_soft_mutation",
