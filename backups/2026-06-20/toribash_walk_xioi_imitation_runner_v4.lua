-- toribash_walk_xioi_imitation_runner_v3.lua
-- Branche walk_xioi_imitation V3
...
local function log(msg)
    echo("[walk_xioi_imitation_v3] " .. tostring(msg))
end
...
local function on_draw2d()
    pcall(function()
        set_color(1, 1, 1, 1)
        draw_text("walk_xioi_imitation V3 | GEN " .. tostring(display_gen) .. " | CAND " .. tostring(display_candidate) .. "/" .. tostring(display_population), 20, 60, 0)
...
remove_hooks("walk_xioi_imitation_runner_v3")
remove_hooks("walk_xioi_runner_v8")
remove_hooks("walk_xioi_runner_v7")
remove_hooks("walk_xioi_runner_v6")

add_hook("new_game", "walk_xioi_imitation_runner_v3", on_new_game)
add_hook("draw2d", "walk_xioi_imitation_runner_v3", on_draw2d)
add_hook("enter_frame", "walk_xioi_imitation_runner_v3", on_enter_frame)
