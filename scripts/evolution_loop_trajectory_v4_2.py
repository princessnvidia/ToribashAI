...
SEED = ROOT / "evolution/trajectory_seed_v4_2.json"
CHAMPION = ROOT / "evolution/trajectory_champion_v4_2.json"
AGENT_LUA = SCRIPT_DIR / "toribashai_agent_current.lua"
RESULT = SCRIPT_DIR / "toribashai_episode_result.json"
POP_DIR = ROOT / "evolution/population_trajectory_v4_2_2"
BEST_DIR = ROOT / "evolution/best_trajectory_v4_2_2"
...
def evaluate(agent, gen, idx):
    ...
    agent["name"] = f"trajectory_v4_2_g{gen:05d}_c{idx:03d}"
...
def main():
    ...
    print("/ls toribash_trajectory_runner_v4_2.lua")
