...
def load_runner_and_start():
    toribash_command("/ls toribash_trajectory_runner_v4_5_reactive.lua", after=0.35)
...
def reject_bad_candidate(result, state):
    ...
    min_steps = max(BASE_MIN_VALID_STEPS, int(state.get("champion_valid_steps", 0)))
...
def main():
    ...
    print("  /ls toribash_trajectory_runner_v4_5_reactive.lua + Space automatique")
    print("")
    print("V4.4 Python reset propre:")
