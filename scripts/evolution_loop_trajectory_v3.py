...
SEED = ROOT / "evolution/trajectory_seed_v3.json"
CHAMPION = ROOT / "evolution/trajectory_champion_v3.json"
AGENT_LUA = SCRIPT_DIR / "toribashai_agent_current.lua"
RESULT = SCRIPT_DIR / "toribashai_episode_result.json"
POP_DIR = ROOT / "evolution/population_trajectory_v3"
BEST_DIR = ROOT / "evolution/best_trajectory_v3"
...
def evaluate(agent, gen, idx):
    ...
    agent["name"] = f"trajectory_v3_g{gen:05d}_c{idx:03d}"
...
def main():
    ...
    print("/ls toribash_trajectory_runner_v3.lua")
